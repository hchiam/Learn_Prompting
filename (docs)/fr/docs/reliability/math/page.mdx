...
## Étape 4 : Auto-cohérence

Enfin, nous utiliserons <Term term="self_consistency">l'Auto-cohérence</Term> pour exécuter le processus ci-dessus plusieurs fois (~5), puis prendre la réponse majoritaire.

## Conclusion

MathPrompter rapporte une précision de 92,5% sur le jeu de données MultiArith(@roy-roth-2015-solving). Le succès de cette technique est un excellent exemple de la façon dont **vous**, en tant qu'ingénieur de prompts, pouvez prendre les méthodes que vous avez apprises tout au long de ce cours et les combiner pour résoudre des problèmes plus complexes.
