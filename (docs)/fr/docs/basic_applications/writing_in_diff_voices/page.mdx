...
L'une des façons les plus rapides de le faire est de spécifier un style d'écriture ou de nommer un auteur célèbre dans le prompt.

Disons que vous voulez un paragraphe sur l'importance de l'amitié.
Un prompt générique comme "Écrivez-moi un paragraphe sur l'importance de l'amitié" donnera une réponse générique de ChatGPT.
...
Et si vous vouliez que GPT-3 écrive un courriel/e-mail ou un blog dans **votre** style ?
...
<br />
Vous pouvez saisir n'importe quel texte que vous avez écrit dans le passé (e-mails,
